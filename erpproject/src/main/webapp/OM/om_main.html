...
<body>
    ...
    <div class="om_body">
        <div class="om_container">
            <h2>주문 관리</h2>
            <hr width="500px">
            <div class="om_search-container">
                <input type="text" class="om_search-input" placeholder="검색어 입력" id="searchInput">
                <button class="om_search-button" onclick="searchPosts()">검색</button>
            </div>
            <ul class="om_post-list">
                <li class="om_post-item">
                    <h2>게시글 제목 1</h2>
                    <p>게시글 내용 1</p>
                </li>
                <li class="om_post-item">
            ...
            <a href="/OM/om_update.html">
            <button class="om_post-button">게시글 작성</button>
            </a>
        </div>
    </div>

<script src="js\addPostNumbers.js"></script>
