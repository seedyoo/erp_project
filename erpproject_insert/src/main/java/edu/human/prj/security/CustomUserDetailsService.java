package edu.human.prj.security;
...
import edu.human.prj.vo.UsersCustom;
...
public class CustomUserDetailsService implements UserDetailsService  {
	...
	public UserDetails loadUserByUsername(String users_id) throws UsernameNotFoundException {
		...
		log.warn("Load Users By UsersVO number: " + users_id);
		UsersVO vo = usersMapper.getUser(users_id);

		log.warn("queried by UsersVO mapper: " + vo);

		return vo == null ? null : new UsersCustom(vo);		
	}
}
